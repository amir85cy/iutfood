...
static constexpr auto qt_meta_stringdata_ZN12CustomerpageE = QtMocHelpers::stringData(
    "Customerpage"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12CustomerpageE[] = {
...
Q_CONSTINIT const QMetaObject Customerpage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12CustomerpageE.offsetsAndSizes,
    qt_meta_data_ZN12CustomerpageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12CustomerpageE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Customerpage, std::true_type>
    >,
    nullptr
} };
...
void *Customerpage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12CustomerpageE.stringdata0))
