...
namespace {
struct qt_meta_tag_ZN9firstpageE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN9firstpageE = QtMocHelpers::stringData(
    "firstpage"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9firstpageE[] = {
...
Q_CONSTINIT const QMetaObject firstpage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9firstpageE.offsetsAndSizes,
    qt_meta_data_ZN9firstpageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9firstpageE_t,
        // Q_OBJECT / Q_GADGET
...
void *firstpage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9firstpageE.stringdata0))
