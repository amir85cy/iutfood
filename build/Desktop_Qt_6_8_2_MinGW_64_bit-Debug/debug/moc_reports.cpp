...
namespace {
struct qt_meta_tag_ZN7ReportsE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN7ReportsE = QtMocHelpers::stringData(
    "Reports"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7ReportsE[] = {
...
Q_CONSTINIT const QMetaObject Reports::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7ReportsE.offsetsAndSizes,
    qt_meta_data_ZN7ReportsE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7ReportsE_t,
        // Q_OBJECT / Q_GADGET
...
void *Reports::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7ReportsE.stringdata0))
