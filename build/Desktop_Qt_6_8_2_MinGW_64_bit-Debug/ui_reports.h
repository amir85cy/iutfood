...
public:
    ...
    void setupUi(QMainWindow *Reports)
    {
        ...
        reportlist->setGeometry(QRect(130, 20, 231, 351));
...
"border-radius:5px;"));
    ...
    void retranslateUi(QMainWindow *Reports)
    {
        ...
        backbtn_2->setText(QCoreApplication::translate("Reports", "<", nullptr));
    } // retranslateUi
